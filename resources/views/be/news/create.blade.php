            ...
            <div class="row">
                <div class="offset-md-3 col-md-6">
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="{{ route('be.postNews') }}" enctype="multipart/form-data" role="form">
                            {{ csrf_field() }}
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="news_category_id" class="form-control">
                                        ...
                                        <option value="{{ $cat->id }}">{{ $cat->news_category }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="editor" class="form-control" rows="3" name="content" placeholder="Enter details">{{ old('content') }}</textarea>
                                    @error('content')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
